...
export const setItem = taskElem => fetch(url, {
  method: 'POST',
  headers: {
...
export const getListElem = id => fetch("".concat(url, "/").concat(id)).then(taskElem => taskElem.json());
export const deleteListElem = id => fetch("".concat(url, "/").concat(id), {
  method: 'DELETE'
});
export const changeListElement = (id, taskElem) => fetch("".concat(url, "/").concat(id), {
  method: 'PUT',
  headers: {
    'Content-Type': 'application/json;charset=utf-8'
  },
